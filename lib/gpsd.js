...
/* Sets the listener in verbose mode */
Listener.prototype.setVerbose = function(verbose) {
    try {
        if (verbose) {
...
Daemon.prototype.start = function(callback) {
    ...
    path.exists(this.device, function (exists) {
...
/* Sets the daemon in verbose mode */
Daemon.prototype.setVerbose = function(verbose) {
    try {
        if (verbose) {
            this.logger.add(winston.transports.Console);
        } else {
